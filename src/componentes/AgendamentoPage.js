...
function AgendamentoPage({ user }) {
  ...
  try {
    ...
    const q1 = query(agendamentosRef,
    ...
    const q2 = query(agendamentosRef,
      where("areaComum", "==", areaComum),
    ...
    const q3 = query(agendamentosRef,
      where("areaComum", "==", areaComum),
      where("start", "<=", novaDataInicio),
      where("end", ">=", novaDataFim)
    );
      ...
      <form onSubmit={handleCriarAgendamento} className="booking-form">
        ...
        <div className="form-row">
          <div className="form-group" style={{minWidth: '200px'}}>
            ...
            <input id="titulo" type="text" placeholder="Ex: Festa de Aniversário" value={titulo} onChange={e => setTitulo(e.target.value)} />
          </div>
          ...
          <div className="form-group">
            ...
            <input id="inicio" type="datetime-local" value={dataInicio} onChange={e => setDataInicio(e.target.value)} />
          </div>
          <div className="form-group">
            <label htmlFor="fim">Fim</label>
            <input id="fim" type="datetime-local" value={dataFim} onChange={e => setDataFim(e.target.value)} />
          </div>
